...
export default function FullScreenModal({
  ...
  return (
    ...
    >
      <div
        className="relative w-full max-w-2xl mx-auto flex flex-col items-center min-h-screen bg-cover bg-center bg-no-repeat"
        style={{ backgroundImage: "url('/images/baimage.jpg')" }}
      >
        <button
